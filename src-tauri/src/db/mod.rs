...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 4,
        name: "004_class_grade",
        sql: include_str!("../../migrations/004_class_grade.sql"),
    },
    Migration {
        version: 5,
        name: "005_payments",
        sql: include_str!("../../migrations/005_payments.sql"),
    },
    Migration {
        version: 6,
        name: "006_class_month_lifecycle",
        sql: include_str!("../../migrations/006_class_month_lifecycle.sql"),
    },
    Migration {
        version: 7,
        name: "007_scores",
    ...
    Migration {
        version: 9,
        name: "009_attendance_class_makeup",
        sql: include_str!("../../migrations/009_attendance_class_makeup.sql"),
    },
    Migration {
        version: 10,
    ...
    Migration {
        version: 13,
        name: "013_archive_class_membership",
        sql: include_str!("../../migrations/013_archive_class_membership.sql"),
    },
];
