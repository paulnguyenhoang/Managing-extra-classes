...
- Roster là các membership HỢP LỆ trong tháng đang chọn (cùng rule lifecycle với PaymentsTab: `joined_month <= month < left_month`); học sinh vào muộn không hiện ở tháng trước, học sinh đã nghỉ không hiện từ leftMonth.
